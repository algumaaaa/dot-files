...
vim.keymap.set("n", "<A-S-Tab>", ":bprevious<CR>", { desc = "Previous buffer" })
vim.keymap.set("n", "<leader>bd", ":bd! <CR>", { desc = "Delete current buffer" })
vim.keymap.set("n", "<leader>fb", ":Telescope buffers<CR>", { desc = "Search current buffers" })
...
vim.keymap.set("n", "<leader>fp", ":NeovimProjectDiscover<CR>", { desc = "Find project" })
...
-- Session configs
vim.keymap.set('n', '<leader>ss', ':mksession!' .. vim.fn.stdpath('config') .. "/session/mysession.vim<CR>",
    { desc = 'Save current session' })
vim.keymap.set('n', '<leader>sl', ':source ' .. vim.fn.stdpath('config') .. "/session/mysession.vim<CR>",
    { desc = 'Save current session' })
...
require("lazy").setup({
    spec = {
        ...
        -- VIMWIKI
        {
            'vimwiki/vimwiki',
            init = function()
                vim.g.vimwiki_path = '~/Documents/Journal/'
        ...
        -- NEOVIM-PROJECT
        {
            ...
            opts = {
                projects = { -- define project roots
                    ...
                    "~/Documents/Projects/Godot/*",
                    "~/Documents/Projects/Unity/*",
                    "~/Documents/Projects/Unreal/*",
